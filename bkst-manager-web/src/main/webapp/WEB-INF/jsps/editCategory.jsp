	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<br/><br/>
				<form role="form" method="post" action="/editCategory.html">
					<div class="form-group">
						 <label for="exampleInputEmail1">分类名称</label>
						 <input type="text" class="form-control" id="exampleInputEmail1" name="cname" value="${category.cname }" />
					</div>
					<input type="hidden" name="cid" value="${category.cid }"/>
					<button type="submit" class="btn btn-default">提交</button>
				</form>
				<h4>
					<a href="/showCategory.html">返回分类列表</a>
				</h4><br/>
